...
#define TIME_BACKGROUND_RECT GRect(1, 123, 70, 40)
#define DATE_BACKGROUND_RECT GRect(73, 123, 70, 40)
...
#define KING_ORIGIN GPoint(82, 54)
#define KING_DEFEAT_ORIGIN GPoint(77, 61)
#define KRACKO_ORIGIN GPoint(64, 24)
#define MR_BRIGHT_ORIGIN GPoint(88, 56)
#define MR_BRIGHT_DEFEAT_ORIGIN GPoint(87, 56)
#define MR_SHINE_ORIGIN GPoint(91, 70)
#define MR_SHINE_DEFEAT_ORIGIN GPoint(91, 65)
#define MR_FROSTY_ORIGIN GPoint(92, 69)
#define MR_FROSTY_DEFEAT_ORIGIN GPoint(92, 68)
